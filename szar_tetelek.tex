...
\begin{figure}[htbp]
	...
	\label{fig:neumann}
	\includegraphics[width=\textwidth]{img/neumann}
\end{figure}
...
\begin{figure}[htbp]	
	\centering
		\includegraphics[width=10cm]{img/adatut}
...
\begin{figure}[htbp]	
	\centering
		\includegraphics[width=\textwidth]{img/csovezetek}
...
\begin{figure}[htbp]	
	\centering
		\includegraphics[width=10cm]{img/csovezetek_vegrehajtas}
...
\begin{figure}[htbp]	
	\centering
		\includegraphics[width=\textwidth]{img/szuperskalaris}
...
\begin{figure}[htbp]	
	\centering
		\includegraphics[width=8cm]{img/valtas_tizes_kettes}
...
\begin{figure}[htbp]	
	\centering
		\includegraphics[width=12cm]{img/valtas_kettes_tizes}
...
\begin{figure}[htbp]	
	\centering
		\includegraphics[width=\textwidth]{img/hibajavitas}
...
\begin{figure}[htbp]	
	\centering
		\includegraphics[width=\textwidth]{img/hamming}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=\textwidth]{img/kapuk_tranzisztor}
	\caption{\textsc{not}-, \textsc{nand}- és \textsc{nor}-kapuk\label{fig:kapuk_tranzisztor}}
\end{figure}

\begin{figure}[htbp]
	\centering
		\includegraphics[width=\textwidth]{img/kapuk}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=\textwidth]{img/tobbsegifv}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=\textwidth]{img/helyettesitokapuk}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=10cm]{img/ekvivalencia}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=6cm]{img/ssi}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=10cm]{img/multiplexer}
	\caption{Multiplexer logikai áramköre.\label{fig:multiplexer}}
\end{figure}

\begin{figure}[htbp]
	\centering
		\includegraphics[width=6cm]{img/tobbsegifvmux}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=10cm]{img/dekodolo}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=8cm]{img/osszehasonlito}
	\caption{2-bites összehasonlító.\label{fig:osszehasonlito}}
\end{figure}

\subsection{Programozható logikai tömb (PLA). Aritmetikai áramkörök. Összeadók. Arit\-me\-ti\-kai-logikai egység. Órák.}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=8cm]{img/pla}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=8cm]{img/lepteto}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=8cm]{img/felosszeado}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=10cm]{img/teljesosszeado}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=10cm]{img/1bitalu}
...
% \subsubsection{Sínek: sínprotokoll, aktív/passzív berendezések, sínszélesség}

% \subsection{Sínek időzítése. Sínütemezés. Sínműveletek.}

% \subsubsection{Sínek időzítése}
% \subsubsection{Sínütemezés}
% \subsubsection{Sínműveletek}
